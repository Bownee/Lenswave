...
internal class PhotoViewerGestureLayout
    @JvmOverloads
    constructor(
        context: Context,
        ...
        private fun canTrack(event: MotionEvent): Boolean = event.pointerCount == 1 && !dragBlocked && gesturesEnabled()
        ...
        private fun updateDrag(event: MotionEvent) {
            ...
            if (elapsedMillis > 0L) {
                ...
                dragVelocityY =
                    if (dragVelocityY == 0f || elapsedMillis > MAX_VELOCITY_SAMPLE_GAP_MILLIS) {
