...
object UiStyle {
    ...
    val navigationSurface: Int get() = color(R.color.lenswave_navigation_surface)
    val navigationSelected: Int get() = color(R.color.lenswave_navigation_selected)
    val navigationBorder: Int get() = color(R.color.lenswave_navigation_border)
    val navigationMuted: Int get() = color(R.color.lenswave_navigation_muted)
