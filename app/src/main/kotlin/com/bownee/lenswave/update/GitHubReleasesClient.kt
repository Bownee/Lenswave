...
internal sealed interface LatestReleaseResult {
    data class Modified(val versionName: String, val etag: String?) : LatestReleaseResult
...
@Singleton
internal class GitHubReleasesClient @Inject constructor() : LatestReleaseClient {
        ...
        return try {
            ...
            when (connection.responseCode) {
                HttpsURLConnection.HTTP_OK -> {
                    val versionName = GitHubReleaseJson.readVersionName(connection.inputStream)
                ...
                HttpsURLConnection.HTTP_NOT_MODIFIED -> LatestReleaseResult.NotModified
                else -> LatestReleaseResult.Unavailable
            }
...
internal object GitHubReleaseJson {
    fun readVersionName(input: InputStream): String? = JsonReader(
