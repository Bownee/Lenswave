...
internal interface ProtonSyncMetadataStore {
    fun readLastSuccessfulSync(userId: String, source: String): Long
...
@Singleton
internal class ProtonSnapshotCoordinator @Inject constructor(
    ...
    ): Boolean = ProtonSyncPolicy.shouldEnumerate(
        source = source,
    ...
    fun commit(userId: String, syncKey: String) {
