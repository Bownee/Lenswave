...
class ProtonGalleryAssetMapperTest {
    ...
    fun stableIdIsPrefixedWithTheProtonSource() {
        val asset = ProtonGalleryPhoto("node-1", captureTimeEpochSeconds = 0L, hasThumbnail = false)
            .toGalleryAsset()
    ...
    fun captureTimeIsConvertedFromSecondsToMillis() {
        val asset = ProtonGalleryPhoto("node-1", captureTimeEpochSeconds = 1_700_000_000L, hasThumbnail = true)
            .toGalleryAsset()
    ...
    fun carriesThumbnailAvailabilityAndPresentationOverrides() {
        val asset = ProtonGalleryPhoto("node-1", captureTimeEpochSeconds = 1L, hasThumbnail = true)
            .toGalleryAsset(
