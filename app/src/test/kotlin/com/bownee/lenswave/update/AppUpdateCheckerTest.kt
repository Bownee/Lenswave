...
class AppUpdateCheckerTest {
    @Test fun newerReleaseIsReturnedAndSuccessfulChecksAreThrottled() = runBlocking {
    ...
    @Test fun equalOlderAndMalformedReleasesAreIgnored() = runBlocking {
    ...
    @Test fun notModifiedResponseUsesCachedReleaseAndItsEtag() = runBlocking {
        val fixture = Fixture(LatestReleaseResult.NotModified)
        fixture.store.state = AppUpdateState(
    ...
    @Test fun failuresRetryAfterOneHourWithoutDiscardingCachedRelease() = runBlocking {
    ...
    @Test fun snoozeSuppressesOnlyThatReleaseForSevenDays() = runBlocking {
        val fixture = Fixture(LatestReleaseResult.NotModified)
        fixture.store.state = AppUpdateState(
            latestVersionName = "0.20.0",
    ...
    private class Fixture(result: LatestReleaseResult) {
    ...
    private class FakeClient(var result: LatestReleaseResult) : LatestReleaseClient {
        var calls = 0
